      ...
      <div class="container">
        ...
        <div class="wrapper">
          <div class="banner-left">
            <a href="/#/product/35">
              <img :src="LeftImg" alt="图片加载失败">
            </a>
          </div>
          <div class="list-box">
            <div class="list" v-for="(item,i) in goodsTopTypeList" :key="i" @click="GoodsDetail(item.goods_id)">
              <div class="item">
...
export default {
  name: 'index',
  components: { ServiceBar, Modal, Swiper, SwiperSlide,NavHeader },
  data() {
    return {
      showModal: false,
      swiperOption: {
      ...
      LeftImg:require('@/assets/phone/mix-alpha.jpg'),
      slideList: [
        {
          id: '42',
  ...
  mounted() {
    this.axios.post("http://42.193.121.151:8000/commonAction/goodsTopTypeData",{
      "type_id":this.$route.params.type_id,
    }).then((response) => {
      this.goodsTopTypeList = response.data[0].goods
    },(error) => {
      console.log(error)
    })
  },
